...
import com.portfolio.gnr.Security.Entity.UsuarioMain;
...
/**
 * Clase que convierte la clase usuario en un UsuarioMain UserDetailsService es
 * propia de Spring Security
 */
@Service
@Transactional
